...
describe User do
  ...
  before(:each) do
    @attr = { 
      ...
      :password => "dingeling",
      :password_confirmation => "dingeling" }
  end
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email adress with no user" do
        nonexistent_user = User.authenticate("linge@dinge.ding", @attr[:password])
  ...
  describe "micropost associations" do
    ...
    it "should delete the microposts, when user is deleted" do
      @user.destroy
